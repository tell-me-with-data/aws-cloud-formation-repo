...
def insert_data(category_tuple):
    ...
    try:
        ...
        cur = conn.cursor()
        sql = """INSERT INTO crm.customer(customer_id, customer_first_name, customer_middle_initial, customer_last_name, city_id, customer_address, load_date) VALUES(%s,%s,%s,%s,%s,%s, CURRENT_DATE);"""
